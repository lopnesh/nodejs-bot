...
resource "null_resource" "setWebhook" {
  provisioner "local-exec" {
      command = "curl https://api.telegram.org/bot615286636:AAEGXzfTieEKF35KfDIQCUX8-UIWDTzlYoE/setWebhook?url=${aws_api_gateway_deployment.test_api_deployment.invoke_url}/event/push"
  }
}